<?php if(!class_exists('Rain\Tpl')){exit;}?> <div class="footer-top-area">
    ...
    <!-- jQuery sticky menu -->
    <script src="/template/site/js/owl.carousel.min.js"></script>
    <script src="/template/site/js/jquery.sticky.js"></script>
    
    <!-- jQuery easing -->
    <script src="/template/site/js/jquery.easing.1.3.min.js"></script>
    
    <!-- Main Script -->
    <script src="/template/site/js/main.js"></script>
    
    <!-- Slider -->
    <script type="text/javascript" src="/template/site/js/bxslider.min.js"></script>
	<script type="text/javascript" src="/template/site/js/script.slider.js"></script>
  </body>
</html>