...
<html lang="pt-br">
  <head>
    ...
    <!-- Font Awesome -->
    <link rel="stylesheet" href="/template/site/css/font-awesome.min.css">
    
    <!-- Custom CSS -->
    <link rel="stylesheet" href="/template/site/css/owl.carousel.css">
    <link rel="stylesheet" href="/template/site/css/style.css">
    <link rel="stylesheet" href="/template/site/css/responsive.css">
    ...
    <div class="site-branding-area">
        <div class="container">
            <div class="row">
                <div class="col-sm-6">
                    <div class="logo">
                        <h1><a href="#"><img src="/template/site/img/logo.png"></a></h1>
                    </div>
                </div>
